 ...
 *
 * @package   local
 * @subpackage uai_toolbox
 * @copyright 2012 Universidad Adolfo Ibanez
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['reservasalas:viewadminroom'] = 'view room admin menu';
...
$string['uai_toolbox:viewtoolboxmanager'] = 'view manager toolbox';
$string['uai_toolbox:viewtoolboxstudent'] = 'view student toolbox';
$string['uai_toolbox:viewtoolboxteacher'] = 'view teacher tollbox';
$string['uai_toolbox:viewtoolboxuser'] = 'view user toolbox';
